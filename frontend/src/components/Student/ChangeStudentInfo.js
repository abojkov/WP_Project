...
export default class ChangeStudentInfo extends Component{
    constructor(props){
        super(props);
        ...
        axios.get('/api/students/' + IDfromProps).then(res => {
            var std = res.data;

            std.embg = parseInt(std.embg);
    ...
    submitForm(){
        axios.post("/api/students/update", JSON.stringify(this.state.student), {
            headers: {
            ...
            buttons: [
                {
                    text: "OK",
                    click: function () {
                        window.location = "/Students/" + self.state.student.index;
                    }
                }
            ]
        });
        ...
        return (
            <div className="container body-content">
                <form onSubmit={() => this.submitForm()}>
                    <br/>
                    <p className="infoMainThird">Менување информации за студент</p>
                    <hr style={{"marginTop":"10px","marginBottom":"10px"}}/>
                        <a href={"/Students/" + this.state.student.index} className="btn btn-warning">
                            <img style={{"width":"18px","marginTop":"-2px"}} src={backIcon}/>
                            Откажи
                        </a>
                        <a onClick={() => this.submitForm()} className="btn btn-info">
                            <img style={{"width":"18px","marginTop":"-2px"}} src={correctIcon}/>
                            Зачувај
                        </a>
                                    ...
                                    <div className="col-sm-5">
                                        ...
                                        <div className="alert alert-info specificAlert specificAlertPlus">
                                            <dl className="dl-horizontal" style={{"marginBottom":"0"}}>
                                                <dt>
                                                    <label className="specificLabel specificLabel2"
                                                           htmlFor="TotalExams">Положени испити</label>
                                                </dt>
                                                ...
                                                <dd>
                                                    <div className="col-md-12">
                                                        <input className="form-control input-sm text-box single-line"
                                                               id="totalExams"
                                                               name="totalExams" disabled type="number">
                                                        </input>
                                                        <span className="field-validation-valid text-danger"
                                                              data-valmsg-for="totalExams">
                                                        </span>
                                                    </div>
                                                </dd>
                                            </dl>
